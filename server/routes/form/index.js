 ...
 * @apiGroup Form
 *
 * @apiParam {Schema.Types.ObjectId} _admin_id object id of company schema
 * @apiParam {Object} template If I could tell you what this is I'd be a god
 ...
 * @apiGroup Form
 *
 * @apiParam {int} template_id id of the template you want to modify
 * @apiParam {template} template what you want your new template to look like
 ...
 * @apiGroup VisitorList
 *
 * @apiParam {string} first_name patient fn
 * @apiParam {string} last_name patient ln
 ...
 * @apiGroup VisitorList
 *
 * @apiParam {object} form the form you are submitting
 * @apiParam {Schema.Types.ObjectId} _admin_id object id of company schema
 * @apiParam {string} firstName patients first name
 * @apiParam {string} lastName patients last name
 * @apiParam {string} patientEmail patients email
