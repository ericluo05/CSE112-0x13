...
{
  var isVal_Form = isValidPhoneNumber(cc, number);

  // if valid, then change the returned JSON object and return it
  if (isVal_Form['isValid'])
  {
    isVal_Form['E.164 Format'] = '+'+cc+number;     //+?? ???????????
  }
  return isVal_Form;
}
